...
// ══════════════════════════════════════════════════════════════════════
// Shared Google Maps Dark Style
// ══════════════════════════════════════════════════════════════════════

/// Dark map style JSON shared across all map screens.
///
/// Suppresses landmarks, transit, and POI labels for a clean stadium HUD.
/// Import from `theme.dart` instead of duplicating in each screen.
const String kGoogleMapDarkStyle = '''
[
